        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="/geekhaven/src/views/admin/html/eliminar_producto.php?id=<?php echo $id; ?>" class="fs-5 text-danger eliminar-producto" data-bs-toggle="modal" data-bs-target="#confirmarEliminarModal">Eliminar</a>
                    </td>
                </tr>
